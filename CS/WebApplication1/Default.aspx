...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v13.2, Version=13.2.10.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dxwschs" %>
<%@ Register Assembly="DevExpress.XtraScheduler.v13.2.Core, Version=13.2.10.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.XtraScheduler" TagPrefix="cc1" %>
        ...
        function OnClientItemClick(s, e) {
            if (e.item.name.indexOf("CopyAppointment") != -1) {
                ...
                if (s.cpMenuName == "AppointmentMenu") {
                    ...
                    aspxSchedulerOnViewMenuClick(s, e);
                }
            }
        }
        ...
        <div>
            ...
            <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" AppointmentDataSourceID="ObjectDataSourceAppointment"
                ...
                <Views>
                    <DayView>
                        <TimeRulers>
                            <cc1:TimeRuler AlwaysShowTimeDesignator="False" ShowCurrentTime="False"></cc1:TimeRuler>
                        </TimeRulers>
