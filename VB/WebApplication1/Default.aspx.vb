...
Namespace WebApplication1
	Partial Public Class [Default]
		...
		Protected Sub ASPxScheduler1_PopupMenuShowing(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxScheduler.PopupMenuShowingEventArgs)
            ...
            If e.Menu.Id.Equals(DevExpress.XtraScheduler.SchedulerMenuItemId.AppointmentMenu) Then
                Dim newItemCopy As New DevExpress.Web.ASPxMenu.MenuItem()
            ...
            End If
            If e.Menu.Id.Equals(DevExpress.XtraScheduler.SchedulerMenuItemId.DefaultMenu) Then
                Dim newItemPaste As New DevExpress.Web.ASPxMenu.MenuItem()
		...
		Protected Sub ASPxScheduler1_CustomCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxClasses.CallbackEventArgsBase)
			If e.Parameter = "PasteAppointment" AndAlso hdCopiedAppointmentID.Value <> "" Then
				...
				If sourceAppointment IsNot Nothing Then
					...
					newAppointment.LabelId = sourceAppointment.LabelId
					...
					newAppointment.StatusId = sourceAppointment.StatusId
